...
# Script adaped from https://github.com/FlowFun/M1-MRD-en-13C/blob/main/Legacy%2010C/Normalization%20NMB%2010C%20navios.R by Benoit DUPONT and https://gist.github.com/yannabraham/c1f9de9b23fb94105ca5
...
for (n in 1:10) {
  ...
  TAG.channel <- 750000 #DIAG=250000 // FU=500000 // NBM=750000
  final.cell.number <- 50000 #DIAG=30000 // FU=500000 // NBM=50000
